...
st.markdown('''<h1 style='text-align: center; color: black;'
            >Предварительная обработка данных часть 2: Сравнение результатов разных способов предобработки </h1>''', 
...
if step_six:
  ...
  То есть, мы добавим тагрет в наши данные, удалим столбец "начало_поездки", "конец_поездки" и зададим новый индекс.
  """)
